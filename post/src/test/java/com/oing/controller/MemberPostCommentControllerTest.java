...
public class MemberPostCommentControllerTest {
    ...
    void 게시물_댓글_생성_테스트() {
        ...
        when(memberPostCommentService.savePostComment(memberPost, request, "1")).thenReturn(memberPostComment);
    ...
    void 게시물_댓글_삭제_테스트() {
        //given
        MemberPost memberPost = spy(new MemberPost("1", "1", "1", "1", "1", "1"));
        MemberPostComment memberPostComment = spy(new MemberPostComment("1", memberPost, "1", "1"));
    ...
    void 게시물_댓글_수정_테스트() {
        ...
        when(memberPostCommentService.updateMemberPostComment(memberPost.getId(), memberPostComment.getId(), updateRequest.content(), "1"))
