...
public enum AiPostType {
    ...
    CHUSEOK_2025("CHUSEOK", "chuseok_2025", LocalDate.of(2025, 9, 29), LocalDate.of(2025, 10, 27)),
    CHRISTMAS_2025("CHRISTMAS", "christmas_2025", LocalDate.of(2025, 12, 23), LocalDate.of(2025, 12, 31));
